...
@section('content')
    <div class="container mx-auto py-2">
        <div class="card-firm bg-gray-300 shadow rounded-lg border">
           <div class="card-firm-header py-3">
           ...
           <div class="card-firm-body bg-white p-4">
               <h3 id="message" class="text-red-500 text-center hidden">La firma no es válida</h3>
                ...
                <div class="flex flex-wrap items-center justify-center mt-8">
                    <a href="{{ route('employees.show', $user->id) }}" class="btn border border-gray-600 text-gray-600 hover:bg-gray-200">Cancelar</a>
                    <input type="button" class="btn text-blue-700 bg-white border border-blue-700 hover:bg-blue-100 cursor-pointer mx-1" id="draw-clearBtn" value="Borrar"></input>
                    <input type="button" class="btn text-white bg-blue-600 hover:bg-blue-500 cursor-pointer mx-1" id="draw-submitBtn" value="Aceptar"></input>
                ...
                <form action="{{ route('employees.updatefirm', $user->id) }}" method="POST" id="form-data-url" class="hidden">
                    @csrf
