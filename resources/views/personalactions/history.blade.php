...
@section('header-content')
    <div class="flex md:w-10/12 mx-auto flex-wrap py-4 border-b">
        <div class="flex-1">
            <h3 class="font-bold text-sm md:text-2xl text-center md:text-left"> <span class="mr-3"><i class="fa fa-file-text" aria-hidden="true"></i></span> Acciones de personal</h3>
        </div>
